...
3. Difficulty levels for AI: - Allow for the player to choose AI difficulty: a. Easy: Choose a random empty cell each time b. Medium: Prioritise blocking human player from winning c. Hard: Implement the algorithm you have created for idea